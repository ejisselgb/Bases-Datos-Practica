...
ALTER TABLE "Grupo 3"."PERFIL" ADD CONSTRAINT "fk_correo" FOREIGN KEY (correo) REFERENCES "Grupo 3"."CUENTA" (correo) MATCH FULL
...
ALTER TABLE "Grupo 3"."PELICULA-FAVORITA" ADD CONSTRAINT "fk_id_perfil" FOREIGN KEY (id_perfil) REFERENCES "Grupo 3"."PERFIL" (id_perfil) MATCH FULL
	ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "Grupo 3"."PELICULA-FAVORITA" ADD CONSTRAINT "fk_id_pelicula" FOREIGN KEY (id_pelicula) REFERENCES "Grupo 3"."PELICULA" (id_pelicula) MATCH FULL
	ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "Grupo 3"."PELICULA-COMENTADA" ADD CONSTRAINT "fk_id_perfil" FOREIGN KEY (id_perfil) REFERENCES "Grupo 3"."PERFIL" (id_perfil) MATCH FULL
	ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "Grupo 3"."PELICULA-COMENTADA" ADD CONSTRAINT "fk_id_pelicula" FOREIGN KEY (id_pelicula) REFERENCES "Grupo 3"."PELICULA" (id_pelicula) MATCH FULL
	ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "Grupo 3"."PELICULA-VISTA" ADD CONSTRAINT "fk_id_perfil" FOREIGN KEY (id_perfil) REFERENCES "Grupo 3"."PERFIL" (id_perfil) MATCH FULL
	ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "Grupo 3"."PELICULA-VISTA" ADD CONSTRAINT "fk_id_pelicula" FOREIGN KEY (id_pelicula) REFERENCES "Grupo 3"."PELICULA" (id_pelicula) MATCH FULL
	ON DELETE CASCADE ON UPDATE CASCADE;
