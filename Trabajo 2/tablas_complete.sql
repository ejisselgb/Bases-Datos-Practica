...
CREATE TABLE "Grupo 6 - T2"."SUBSCRIPTIONS" (
...
--ALTER TABLE "Grupo 6 - T2"."SUBSCRIPTIONS" ADD CONSTRAINT pk_suscriptions PRIMARY KEY(id_subscription);
--foraneas
--ALTER TABLE "Grupo 6 - T2"."SUBSCRIPTIONS" ADD CONSTRAINT fk_user FOREIGN KEY(id_user) REFERENCES "Grupo 6 - T2"."USERS" (id_user);
--ALTER TABLE "Grupo 6 - T2"."SUBSCRIPTIONS" ADD CONSTRAINT fk_plan FOREIGN KEY(id_plan) REFERENCES "Grupo 6 - T2"."PLANS" (id_plan);
...
CREATE TABLE "Grupo 6 - T2"."MOVIES" (
    ...
    director varchar(50),
	poster_url varchar(400), --no se si eso esta bueno
    trailer_url varchar(400)
);
...
CREATE TABLE "Grupo 6 - T2"."CHAPTERS_SERIES"(
    ...
    season int,
	title varchar(100),
	img_url varchar(400) --no se si eso esta bueno
...
--ALTER TABLE "Grupo 6 - T2"."FAVORITE_MOVIES" ADD CONSTRAINT fk_profile FOREIGN KEY(id_profile) REFERENCES "Grupo 6 - T2"."PROFILES" (id_profile); 
...
--ALTER TABLE "Grupo 6 - T2"."FAVORITE_SERIES" ADD CONSTRAINT fk_profile FOREIGN KEY(id_profile) REFERENCES "Grupo 6 - T2"."PROFILES" (id_profile); 
...
CREATE TABLE "Grupo 6 - T2"."CITIES" (
    ...
    id_zone varchar(20) NOT NULL, --foranea de deparment
    name varchar(20)
